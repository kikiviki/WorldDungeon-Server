...
-- ============================ CAP REACHABILITY ==============================
-- Caps follow: Mk.I = base+120 (fills at L30), Mk.II = base+200 (L50),
-- Mk.III = base+260 (L65). Every cap is therefore REACHABLE inside 1-65, and
-- each tier extends the scaling window rather than sitting inert.
--
-- The first pass did not do this. With formula 105 (base + level*4) the raw
-- value at 65 is only base+260, so the original Mk.III caps needed levels 84 to
-- 122 to bind and did nothing at all. On two of the four lines Mk.II's cap was
-- also unreachable, which made Mk.II and Mk.III produce IDENTICAL output at max
-- level - the elite chase tier was worth literally zero over the mid tier.
-- ============================================================================
...
VALUES
  ...
  (42714, 'Intercession Mk. II',  83,  5, 502001, 5, 1, 0, 0, 0, 12000, 1500, 120, 98, 100, 0, 1,
   0, 60, 105, 260,   254,254,254,254,254, 254,254,254,254,254,254),
  (42715, 'Intercession Mk. III', 83, 10, 502001, 5, 1, 0, 0, 0, 12000, 1500, 120, 98, 100, 0, 1,
   0, 60, 105, 320,   254,254,254,254,254, 254,254,254,254,254,254),
  ...
  (42722, 'Communal Light Mk. I',   83,  1, 502004, 3, 1, 0, 0, 6000, 0, 1500, 150, 98, 100, 100, 1,
   0, 70, 105, 190,   254,254,254,254,254, 254,254,254,254,254,254),
  (42723, 'Communal Light Mk. II',  83,  5, 502004, 3, 1, 0, 0, 6000, 0, 1500, 150, 98, 100, 100, 1,
   0, 70, 105, 270,   254,254,254,254,254, 254,254,254,254,254,254),
  (42724, 'Communal Light Mk. III', 83, 10, 502004, 3, 1, 0, 0, 6000, 0, 1500, 150, 98, 100, 100, 1,
   0, 70, 105, 330,   254,254,254,254,254, 254,254,254,254,254,254),
